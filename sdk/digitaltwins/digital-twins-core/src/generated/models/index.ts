...
export interface BulkImportJobCollection {
...
/** Contains response data for the list operation. */
export type ImportJobsListResponse = BulkImportJobCollection;
...
/** Contains response data for the add operation. */
export type ImportJobsAddResponse = BulkImportJob;
...
/** Contains response data for the getById operation. */
export type ImportJobsGetByIdResponse = BulkImportJob;
...
export type ImportJobsCancelResponse = BulkImportJob;
...
/** Contains response data for the listNext operation. */
export type ImportJobsListNextResponse = BulkImportJobCollection;
