...
export const BulkImportJobCollection: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "BulkImportJobCollection",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const BulkImportJob: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "BulkImportJob",
    modelProperties: {
